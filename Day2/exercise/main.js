...
let charEx = /[^A-Za-z0-9\s]/g  //added space after 9 to keep space in the string ie not replace space
...
console.log(newSentence.match(/\bteacher\b/gi).length)
console.log(newSentence.match(/\band\b/gi).length)
console.log(newSentence.match(/\blove\b/gi).length)
console.log(newSentence.match(/\bteaching\b/gi).length)
console.log(newSentence.match(/\bthere\b/gi).length)
console.log(newSentence.match(/\bis\b/gi).length)
console.log(newSentence.match(/\bnothing\b/gi).length)
console.log(newSentence.match(/\bas\b/gi).length)
console.log(newSentence.match(/\bmore\b/gi).length)
console.log(newSentence.match(/\brewarding\b/gi).length)
console.log(newSentence.match(/\beducating\b/gi).length)
console.log(newSentence.match(/\bempowering\b/gi).length)
console.log(newSentence.match(/\bpeople\b/gi).length)
console.log(newSentence.match(/\bfound\b/gi).length)
console.log(newSentence.match(/\binteresting\b/gi).length)
console.log(newSentence.match(/\bthan\b/gi).length)
console.log(newSentence.match(/\bany\b/gi).length)
console.log(newSentence.match(/\bother\b/gi).length)
console.log(newSentence.match(/\bjobs\b/gi).length)
console.log(newSentence.match(/\bdoes\b/gi).length)
console.log(newSentence.match(/\bthis\b/gi).length)
console.log(newSentence.match(/\bmotivate\b/gi).length)
console.log(newSentence.match(/\byou\b/gi).length)
console.log(newSentence.match(/\bto\b/gi).length)
console.log(newSentence.match(/\bbe\b/gi).length)
console.log(newSentence.match(/\ba\b/gi).length)
console.log(newSentence.match(/\bteacher\b/gi).length)
console.log(newSentence.match(/\b30DaysOfJavaScript\b/gi).length)
console.log(newSentence.match(/\balso\b/gi).length)
console.log(newSentence.match(/\bthe\b/gi).length)
console.log(newSentence.match(/\bresult\b/gi).length)
console.log(newSentence.match(/\bof\b/gi).length)
